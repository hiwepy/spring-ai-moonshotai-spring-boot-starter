...
public class MoonshotAiImageOptions implements ImageOptions {
    ...
    public static class Builder {
        ...
        private final MoonshotAiImageOptions options;

        private Builder() {
            this.options = new MoonshotAiImageOptions();
        }
        ...
        public MoonshotAiImageOptions build() {
            return options;
        }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof MoonshotAiImageOptions that))
            return false;
    ...
    public String toString() {
        return "MoonshotAiImageOptions{" + "n=" + n + ", model='" + model + '\'' + ", width=" + width + ", height=" + height
