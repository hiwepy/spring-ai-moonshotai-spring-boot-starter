...
public class MoonshotAiApi {
     ...
     */
    public MoonshotAiApi(String baseUrl, String apiKey, RestClient.Builder restClientBuilder,
    ...
    /**
     * List of well-known Moonshot AI chat models.
     * https://open.bigmodel.cn/dev/api#language
     *
     * <p>
     * Moonshot AI AI provides three API endpoints featuring five leading Large Language
     * Models:
     * </p>
     * <ul>
    ...
    /**
     * List of well-known Moonshot AI embedding models.
     ...
     * @return Entity response with {@link MoonshotAiApi.ChatCompletion} as a body and HTTP status code
     * and headers.
     */
    public ResponseEntity<MoonshotAiApi.ChatCompletion> chatCompletionEntity(MoonshotAiApi.ChatCompletionRequest chatRequest) {
    ...
    private MoonshotAiStreamFunctionCallingHelper chunkMerger = new MoonshotAiStreamFunctionCallingHelper();
    ...
    public record EmbeddingRequest(
        ...
        public EmbeddingRequest(String input) {
            this(input, MoonshotAiApi.EmbeddingModel.EMBED.getValue());
        }
    }
    ...
    public record EmbeddingList<T>(
            ...
            @JsonProperty("model") String model,
            @JsonProperty("usage") MoonshotAiApi.Usage usage) {
        // @formatter:on
    }
     ...
     * @return Returns list of {@link MoonshotAiApi.Embedding} wrapped in {@link MoonshotAiApi.EmbeddingList}.
