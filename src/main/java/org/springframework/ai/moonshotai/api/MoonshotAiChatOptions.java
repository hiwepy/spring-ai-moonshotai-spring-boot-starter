...
public class MoonshotAiChatOptions implements FunctionCallingOptions, ChatOptions {
    ...
    private @JsonProperty("tools") List<MoonshotAiApi.FunctionTool> tools;

    /**
     * 用于控制模型是如何选择要调用的函数，仅当工具类型为function时补充。默认为auto，当前仅支持auto
     */
    @NestedConfigurationProperty
    private @JsonProperty("tool_choice") MoonshotAiApi.ChatCompletionRequest.ToolChoice toolChoice;
    ...
    public static class Builder {
        ...
        private final MoonshotAiChatOptions options = new MoonshotAiChatOptions();
        ...
        public Builder withTools(List<MoonshotAiApi.FunctionTool> tools) {
            this.options.tools = tools;
            return this;
        }

        public Builder withToolChoice(MoonshotAiApi.ChatCompletionRequest.ToolChoice toolChoice) {
    ...
    /**
     * Convert the {@link MoonshotAiChatOptions} object to a {@link Map} of key/value pairs.
    ...
    /**
     * Helper factory method to create a new {@link MoonshotAiChatOptions} instance.
     * @return A new {@link MoonshotAiChatOptions} instance.
     */
    public static MoonshotAiChatOptions create() {
        return new MoonshotAiChatOptions();
    }
